...
TocOpen: false
hideMeta: true
keywords: ["GibFlow privacy policy", "GibFlow data protection", "Gibraltar GDPR", "personal data GibFlow", "data controller Gibraltar", "GibFlow data rights"]
---

<div class="not-prose mb-8 flex flex-wrap gap-3 items-start">
  <div class="badge badge-primary">Effective: 23 February 2026</div>
  <div class="badge badge-ghost">Last updated: 23 February 2026</div>
</div>
...
<div class="card bg-base-200 not-prose my-4">
  <div class="card-body">
    <p class="font-semibold text-base-content mb-1">Data Controller</p>
...
<div class="alert alert-info not-prose my-4">
  ...
  <span>Payment card details are processed securely by third-party payment providers and are <strong>not stored by GibFlow</strong>.</span>
</div>
...
To exercise your rights, contact us at [info@gibflow.gi](mailto:info@gibflow.gi). We may require proof of identity before responding.

## Cookies & Analytics (Website)

If you visit our website, we may use cookies and analytics tools to understand usage trends, improve user experience, and monitor performance. Please see our [Cookie Policy](/cookies/) for full details. You can control cookies via your browser settings at any time.
...
<div class="card bg-base-200 not-prose mt-2">
  <div class="card-body">
    <h3 class="font-semibold text-base-content mb-1">Questions or complaints?</h3>
    <address class="not-italic text-sm text-base-content/80 leading-relaxed">
      <strong>Gib Flow Ltd</strong><br>
      12/1 Collage Lane, Gibraltar<br>
      <a href="mailto:info@gibflow.gi" class="link link-primary">info@gibflow.gi</a>
    </address>
